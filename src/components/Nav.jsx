...
const Navbar = ({cartData}) => {
  ...
  return (
    <div className=" bg-base-100 shadow-sm sticky top-0 z-20  w-full py-5 px-6">
      ...
      <div className="">
        ...
        <div className="dropdown md:hidden">
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle"><svg xmlns="http://www.w3.org/2000/svg"  className="h-5 w-5" fill="none"viewBox="0 0 24 24"stroke="currentColor">{" "}<path strokeLinecap="round" strokeLinejoin="round"strokeWidth="2"d="M4 6h16M4 12h16M4 18h7"/>{" "} </svg>
          </div>
        ...
        <div className="dropdown dropdown-end">
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
            <div className="indicator">
              ...
              </svg>{cartData.length === 0 ? null :  <span className="badge badge-xs indicator-item bg-red-500 w-3 text-white">{cartData.length}</span>}
            </div>
          </div>
          <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-1 mt-3 w-52 shadow">
            <div className="card-body">
              <span className="text-lg font-bold">6 Items</span>
              <span className="text-info">Subtotal: $230</span>
