...
const ToggleBTN = ({productsFetch,cartData,active,setActive}) => {
  ...
  return (
   <div className={`mt-5 md:mt-16 lg:mt-24 container md:max-w-7xl mx-auto sticky -top-16 z-10 transition-all duration-300 ${isScrolled ? 'bg-white py-2' :'bg-transparent py-8'}`}>
    ...
    <p className="text-center py-2 md:py-5 text-gray-500">Choose from our curated collection of premium digital products designed <br />to boost your productivity and creativity.</p>
